...
const SERVICES: LegacyService[] = [
  ...
  },
  {
    ...
    description: "Use the legacy calibration request form. New requests are now handled through Instances (Calibration Service Request).",
    status: "bridge",
  ...
  },
  {
    ...
    description: "Legacy portal for BOBS-recognised inspection body coordination. Full digital workflow is now available.",
    status: "bridge",
...
export default async function LegacyServicesPage() {
  ...
  return (
    <div className="max-w-5xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>Legacy Services Portal</h1>
              ...
              {catServices.map((svc) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-sm font-semibold mb-1" style={{ color: "var(--text-primary)" }}>{svc.title}</h3>
                    <p className="text-xs leading-relaxed flex-1" style={{ color: "var(--text-secondary)" }}>{svc.description}</p>
      ...
      <div
        ...
        style={{ background: "var(--brand-light)", borderColor: "var(--brand-mid)" }}
      >
        ...
        <p className="text-xs leading-relaxed" style={{ color: "var(--text-primary)" }}>
          ...
          and reviewer decision workflows. Contact the Instances team to migrate additional services.
        </p>
      </div>
    </div>
  );
