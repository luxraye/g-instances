...
export function ProvisionForm({
  ...
  const selectStyle = { borderColor: "var(--border)", background: "#ffffff" };
  ...
  return (
    <form onSubmit={submit} className="rounded-xl border bg-white p-5 space-y-4" style={{ borderColor: "var(--border)" }}>
      <h2 className="text-sm font-semibold" style={{ color: "var(--brand)" }}>Provision new submission</h2>

      <div>
        <label className="block text-xs font-medium mb-1.5" style={{ color: "var(--text-primary)" }}>Service template</label>
      ...
      <div>
        <label className="block text-xs font-medium mb-1.5" style={{ color: "var(--text-primary)" }}>Assign to organisation</label>
      ...
      <div>
        <label className="block text-xs font-medium mb-1.5" style={{ color: "var(--text-primary)" }}>Submission deadline</label>
        <input
          type="date"
          className={selectCls}
          style={selectStyle}
