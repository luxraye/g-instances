...
export function TemplateForm() {
  ...
  return (
    <form onSubmit={submit} className="rounded-xl border bg-white p-5 space-y-4" style={{ borderColor: "var(--border)" }}>
      <h2 className="text-sm font-semibold" style={{ color: "var(--brand)" }}>Create new template</h2>
      ...
      <div>
        <label className="block text-xs font-medium mb-1.5" style={{ color: "var(--text-primary)" }}>Description</label>
        <input
          className={inputCls}
          style={inputStyle}
      ...
      <div>
        ...
        <textarea
          ...
          style={{ borderColor: "var(--border)", background: "#f8f9fa", minHeight: "220px" }}
          value={schemaText}
