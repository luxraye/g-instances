...
function Bar({ pct, color }: { pct: number; color: string }) {
  return (
    <div className="h-3 w-full rounded-full overflow-hidden" style={{ background: "#fff" }}>
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div className="flex items-start justify-between">
        ...
        <span className="rounded-md border px-3 py-1.5 text-xs" style={{ borderColor: "var(--border)", color: "var(--text-secondary)" }}>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          ...
          <div key={k.label} className="rounded-xl border  p-5" style={{ borderColor: "var(--border)" }}>
            <p className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>{k.value}</p>
            <p className="text-sm font-medium mt-0.5" style={{ color: "var(--text-primary)" }}>{k.label}</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border  p-5" style={{ borderColor: "var(--border)" }}>
          <h2 className="text-base font-semibold mb-4" style={{ color: "var(--text-primary)" }}>Submissions by status</h2>
        ...
        <div className="rounded-xl border  p-5 space-y-5" style={{ borderColor: "var(--border)" }}>
          <h2 className="text-base font-semibold" style={{ color: "var(--text-primary)" }}>Performance indicators</h2>
          ...
          {[
            ...
            <div key={ind.label}>
              <div className="flex justify-between items-baseline mb-1">
                <span className="text-sm font-medium" style={{ color: "var(--text-primary)" }}>{ind.label}</span>
      ...
      {/* By template */}
      <div className="rounded-xl border  p-5" style={{ borderColor: "var(--border)" }}>
        <h2 className="text-base font-semibold mb-4" style={{ color: "var(--text-primary)" }}>Submissions by service type</h2>
        {byTemplate.length === 0 ? (
              ...
              return (
                <div key={t.code}>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="font-semibold" style={{ color: "var(--text-primary)" }}>{t.count}</span>
                  </div>
                  <Bar pct={pct} color="var(--brand-mid)" />
                </div>
              );
            })}
          </div>
      ...
      <div
        ...
        style={{ background: "var(--brand-light)", borderColor: "var(--brand-mid)", color: "var(--text-primary)" }}
      >
        <strong style={{ color: "var(--text-primary)" }}>Export:</strong> Full data export to CSV/Excel and scheduled report delivery
